...
namespace Fullscreen {
    /// <summary>
    /// Helper class for saving preferences.
    /// </summary>
    ...
    public sealed class PrefItem<T> {
        ...
        /// <summary>
        /// The default value to use when there's none saved.
        /// </summary>
        public T DefaultValue { get; private set; }

        /// <summary>
        /// A label and an explanation of what this item is for.
        /// </summary>
        public GUIContent Content { get; private set; }

        /// <summary>
        /// Callback called whenever the saved value changes.
        /// </summary>
        public Action<T> OnValueSaved { get; set; }

        /// <summary>
        /// The value saved by this instance.
        /// </summary>
        public T Value {
        ...
        public PrefItem(string key, T defaultValue, string text, string tooltip) {
            ...
            FullscreenPreferences.preferenceKeys.Add(Key);
    ...
    /// <summary>
    /// Helper class for drawing the <see cref="PrefItem{T}"/> in the <see cref="PreferencesWindow"/>.
    /// </summary>
    public static class PrefItemGUI {
        ...
        public static void DoGUI(this PrefItem<MutipleWindow> pref) {
            pref.Value = (MutipleWindow)EditorGUILayout.EnumPopup(pref.Content, pref.Value);
        }
